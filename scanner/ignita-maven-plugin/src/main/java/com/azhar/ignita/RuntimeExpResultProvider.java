...
@Named
@Singleton
public class RuntimeExpResultProvider implements ResultProvider {
    @Override
    public String getVersion(String command) throws MojoExecutionException {
        try {
            ...
            // return the output
            builder.append(TableGenerator.x());
...
class TableGenerator {
    ...
    public static String x() {
        ...
        headersList.add("Vulnerabilities(OWASP-10)");
